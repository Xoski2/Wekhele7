        ...
        <div className="max-w-7xl mx-auto px-6 pt-24 pb-16 md:pb-20 grid md:grid-cols-2 gap-12 md:gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            >
              <motion.button
                onClick={() => openModal()}
                className="flex items-center gap-3 px-8 py-4 rounded-full bg-w7-gold text-w7-dark font-semibold text-base w-full sm:w-auto justify-center cursor-pointer"
